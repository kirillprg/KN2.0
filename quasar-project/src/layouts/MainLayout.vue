...
<q-layout view="hhh lpR fFf">
    <q-header>
        ...
        <div class="q-px-lg q-pt-l q-mb-l">
            <div class="text-h3">Kate _Nehty</div>
        ...
        <q-img src="src\statics\nehty1.jpg" class="header-image absolute-top" />

    </q-header>
    <q-drawer show-if-above v-model="leftDrawerOpen" :width="200" ide="left" elevated>
        <q-list>
            <q-item-label header>
                Užitečné odkazy
            </q-item-label>
